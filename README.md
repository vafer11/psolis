...
* [`src/psolis/`](src/psolis/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/psolis/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `psolis` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/psolis/config.cljs) defaults to `true` in
...
```clj
(ns psolis.example
  (:require [psolis.config :as config])
